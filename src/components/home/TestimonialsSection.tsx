  ...
  return (
    <section className="py-24 bg-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          Don't just take our word for it — hear from our wonderful community of food lovers who make our cafe special every single day.
        </SectionTitle>
        ...
        <Swiper
          ...
          pagination={{
            clickable: true,
            bulletClass: 'swiper-pagination-bullet !bg-primary-foreground/30 !w-3 !h-3',
