  ...
  return (
    <section className="py-24 bg-cafe-cream">
      <div className="w-full px-4 lg:px-8">
        <SectionTitle title="Moments at Artisan" subtitle="Our Gallery">
          Take a peek into our world — the cozy corners, the artful creations,
          and the smiles we share every day.
        </SectionTitle>
