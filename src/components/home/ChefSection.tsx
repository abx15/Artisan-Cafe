...
const chefs = [
  {
    ...
    description: 'With 15 years of experience from Paris to Mumbai, Ananya brings French finesse to Indian flavors.',
  },
  {
    name: 'Rohan Kapoor',
    role: 'Master Chocolatier',
    image: 'https://images.unsplash.com/photo-1583394838336-acd977736f90?w=300&h=300&fit=crop',
    description: 'Trained in Belgium, Rohan crafts each chocolate with precision and passion.',
  },
  {
    name: 'Mei Lin Wong',
    role: 'Asian Cuisine Specialist',
    image: 'https://images.unsplash.com/photo-1594744803329-e58b31de8bf5?w=300&h=300&fit=crop',
    description: 'Our Chaumin queen brings authentic Indo-Chinese flavors perfected over 10 years.',
  },
];
    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-4 lg:px-8">
        <SectionTitle
          ...
          subtitle="The Team"
        >
          The passionate souls behind every delicious creation. Our talented team brings years of expertise and a love for culinary arts.
        </SectionTitle>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {chefs.map((chef, index) => (
            ...
            >
              ...
              <p className="text-accent font-medium text-sm mb-3">{chef.role}</p>
